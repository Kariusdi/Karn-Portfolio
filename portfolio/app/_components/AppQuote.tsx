...
const AppQuote: FC<AppQuoteProps> = ({ bold, desc }) => {
  return (
    <div className="relative max-w-[700px] bg-white rounded-xl transition-all duration-300 shadow-lg border-green-50 border-2 px-4 pt-8 pb-4 animate-tilt m-5 text-center space-y-4">
